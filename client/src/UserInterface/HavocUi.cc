...
void HavocNamespace::UserInterface::HavocUi::UpdateSessionsHealth()
{
    for ( auto& session : HavocX::Teamserver.Sessions )
    {
        ...
        auto seconds = QDateTime::fromSecsSinceEpoch( diff, Qt::UTC ).toUTC().toString("s");
        auto minutes = QDateTime::fromSecsSinceEpoch( diff, Qt::UTC ).toUTC().toString("m");
        auto hours   = QDateTime::fromSecsSinceEpoch( diff, Qt::UTC ).toUTC().toString("h");
        auto days    = QDateTime::fromSecsSinceEpoch( diff, Qt::UTC ).toUTC().toString("d");
