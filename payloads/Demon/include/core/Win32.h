...
typedef struct _HV_PROC_THREAD_ATTRIBUTE_ENTRY
{
    ULONG_PTR  Attribute;
    ULONG_PTR  Size;
    ULONG_PTR* pValue;
    ULONG_PTR  Unknown;
} HV_PROC_THREAD_ATTRIBUTE_ENTRY, *PHV_PROC_THREAD_ATTRIBUTE_ENTRY;
...
typedef struct _HV_PROC_THREAD_ATTRIBUTE_LIST
{
    ULONG_PTR                      Length;
    HV_PROC_THREAD_ATTRIBUTE_ENTRY Entry;
} HV_PROC_THREAD_ATTRIBUTE_LIST, *PHV_PROC_THREAD_ATTRIBUTE_LIST;
...
typedef OBJECT_ATTRIBUTES            OBJ_ATTR;
typedef HV_PROC_THREAD_ATTRIBUTE_LIST   THD_ATTR_LIST;
